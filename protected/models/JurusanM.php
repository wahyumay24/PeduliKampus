...
/**
 * This is the model class for table "jurusan_m".
 *
 * The followings are the available columns in table 'jurusan_m':
 * @property integer $id
 ...
 */
class JurusanM extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('kode, nama, created_by, created_date', 'required','message'=>'Please fill in the {attribute}'),
	 ...
	 * @return JurusanM the static model class
	 */
