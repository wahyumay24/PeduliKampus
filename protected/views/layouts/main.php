...
<head>
    ...
    <title>Accounting System Information</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard --> 
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $this->createUrl("dashboard/dashboard"); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo $this->createUrl("/angkatan/index"); ?>">Batch</a>
                        <a class="collapse-item" href="<?php echo $this->createUrl("/jurusan/index"); ?>">Jurusan</a>
                        <a class="collapse-item" href="<?php echo $this->createUrl("user/index"); ?>">User</a>
                        <a class="collapse-item" href="<?php echo $this->createUrl("period/index"); ?>">Period</a>
                    </div>
                </div>
            </li>
    ...
    <!-- Webcam -->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/webcam.min.js"></script>
</body>
